...
public class ViewAsignarTrabajos extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewAsignarTrabajos
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAsignarTrabajos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAsignarTrabajos().setVisible(true);
            }
        });
    }
